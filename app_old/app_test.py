...
# There are some things to clean up. The use of global variables should
# be avoided - use some form of function to change them.
# Also, the implementation is not very clean and should be dealt with.
...
<StartScreen>:
    ...
    BoxLayout:
        ...
        BoxLayout:
            Button:
                text: 'Clustering Age~ProtectionNeed~LongTermCareNeed'
                font_size: 30
                on_release: app.root.current = 'first_clustering_age'
        BoxLayout:
            Button:
                text: 'Clustering ProtectionNeed~LongTermCareNeed'
                font_size: 30
